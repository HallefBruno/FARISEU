 ...
 */
@WebFilter(filterName = "FiltroOperacaoDB", urlPatterns = {"/pgInterna"})
public class FiltroOperacaoDB implements Filter {
    
    private static final boolean debug = false;

    private FilterConfig filterConfig = null;
    
    public FiltroOperacaoDB() {
    }    
    
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response) throws IOException, ServletException {
        if (debug) {
            log("FiltroOperacaoDB:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        if (debug) {
            log("FiltroOperacaoDB:DoAfterProcessing");
        }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("FiltroOperacaoDB: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("FiltroOperacaoDB()");
        }
        StringBuffer sb = new StringBuffer("FiltroOperacaoDB(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("FiltroOperacaoDB::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("FiltroOperacaoDB::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("FiltroOperacaoDB::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("FiltroOperacaoDB::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("FiltroOperacaoDB::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
